...
//       const jsonPayload = JSON.parse(atob(padded));
      
//       return jsonPayload.id || null;
//     } catch (err) {
//       return null;
//     }
//   };
...
// Leave Requests
export const getLeaveRequests = (params = {}) => axios.get(BASE, { params });
export const createLeaveRequest = (payload) => axios.post(BASE, payload);
