...
export default function Footer() {
  return (
    <footer id="contact" className="relative bg-slate-950 border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-bold text-white">FlowHR</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              Transforming HR management with intelligent automation and seamless workforce solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Roadmap</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Press Kit</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:hello@flowhr.com" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">hello@flowhr.com</a>
              </li>
              <li className="flex items-start gap-2">
                <Phone className="w-4 h-4 text-cyan-400 mt-1 flex-shrink-0" />
                <a href="tel:+1234567890" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">+1 (234) 567-890</a>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-cyan-400 mt-1 flex-shrink-0" />
                <span className="text-gray-400 text-sm">San Francisco, CA 94102</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-gray-400 text-sm">
              © 2025 FlowHR. All rights reserved.
            </p>
